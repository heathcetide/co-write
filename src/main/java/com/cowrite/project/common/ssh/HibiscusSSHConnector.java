package com.cowrite.project.common.ssh;

import com.cowrite.project.config.SSHProperties;
import com.cowrite.project.exception.SSHException;
...
public class HibiscusSSHConnector {
    ...
    public HibiscusSSHConnector(WebSocketSession webSocketSession, SSHProperties sshProperties, String sessionId) {
...
//            channel.setEnv("LANG", "en_US.UTF-8");
            ...
            throw new SSHException("ssh连接失败", username, e);
        }
        try {
